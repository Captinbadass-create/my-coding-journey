...
- Learning Python fundamentals and core concepts on **freeCodeCamp**
- Building interactive command-line tools and mini-games
- Structuring clean, readable, and well-documented Python code
...
| `assignment.py` | Practice exercises, curriculum tasks, and code submissions. |
| `README.md` | Overview and roadmap for this repository. |

---

## 📈 Milestone Checklist

- [x] Python Basics & Syntax
- [x] Booleans & Conditionals
